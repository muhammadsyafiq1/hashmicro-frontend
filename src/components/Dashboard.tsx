  ...
  return (
    <div style={{ padding: 32 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 16, marginTop: 32 }}>
        {[
          { title: "Products CRUD", desc: "Create, Read, Update, Delete products with category", emoji: "📦" },
          { title: "Categories CRUD", desc: "Manage product categories", emoji: "📂" },
          { title: "String Checker", desc: "Sensitive & non-sensitive character matching", emoji: "🔍" },
        ].map((c) => (
